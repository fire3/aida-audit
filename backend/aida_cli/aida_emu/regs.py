...
class Regs:
    ...
    def _get_uc_reg(self, name: str) -> int:
        ...
        reg_map = {
            "x86_64": {
                "rax": unicorn.UC_X86_REG_RAX, "rbx": unicorn.UC_X86_REG_RBX,
                "rcx": unicorn.UC_X86_REG_RCX, "rdx": unicorn.UC_X86_REG_RDX,
                "rsi": unicorn.UC_X86_REG_RSI, "rdi": unicorn.UC_X86_REG_RDI,
                "rbp": unicorn.UC_X86_REG_RBP, "rsp": unicorn.UC_X86_REG_RSP,
                "rip": unicorn.UC_X86_REG_RIP, "rflags": unicorn.UC_X86_REG_RFLAGS,
                "r8": unicorn.UC_X86_REG_R8, "r9": unicorn.UC_X86_REG_R9,
                "r10": unicorn.UC_X86_REG_R10, "r11": unicorn.UC_X86_REG_R11,
                "r12": unicorn.UC_X86_REG_R12, "r13": unicorn.UC_X86_REG_R13,
                "r14": unicorn.UC_X86_REG_R14, "r15": unicorn.UC_X86_REG_R15,
            },
            "x86_32": {
                "eax": unicorn.UC_X86_REG_EAX, "ebx": unicorn.UC_X86_REG_EBX,
                "ecx": unicorn.UC_X86_REG_ECX, "edx": unicorn.UC_X86_REG_EDX,
                "esi": unicorn.UC_X86_REG_ESI, "edi": unicorn.UC_X86_REG_EDI,
                "ebp": unicorn.UC_X86_REG_EBP, "esp": unicorn.UC_X86_REG_ESP,
                "eip": unicorn.UC_X86_REG_EIP, "eflags": unicorn.UC_X86_REG_EFLAGS,
            },
            "arm": {
                "pc": unicorn.UC_ARM_REG_PC, "sp": unicorn.UC_ARM_REG_SP,
                "lr": unicorn.UC_ARM_REG_LR, "r0": unicorn.UC_ARM_REG_R0,
                "r1": unicorn.UC_ARM_REG_R1, "r2": unicorn.UC_ARM_REG_R2,
                "r3": unicorn.UC_ARM_REG_R3, "r4": unicorn.UC_ARM_REG_R4,
                "r5": unicorn.UC_ARM_REG_R5, "r6": unicorn.UC_ARM_REG_R6,
                "r7": unicorn.UC_ARM_REG_R7, "r8": unicorn.UC_ARM_REG_R8,
                "r9": unicorn.UC_ARM_REG_R9, "r10": unicorn.UC_ARM_REG_R10,
            },
            "arm64": {
                "pc": unicorn.UC_ARM64_REG_PC, "sp": unicorn.UC_ARM64_REG_SP,
                "x0": unicorn.UC_ARM64_REG_X0, "x1": unicorn.UC_ARM64_REG_X1,
                "x2": unicorn.UC_ARM64_REG_X2, "x3": unicorn.UC_ARM64_REG_X3,
                "x4": unicorn.UC_ARM64_REG_X4, "x5": unicorn.UC_ARM64_REG_X5,
                "x6": unicorn.UC_ARM64_REG_X6, "x7": unicorn.UC_ARM64_REG_X7,
                "x8": unicorn.UC_ARM64_REG_X8, "x9": unicorn.UC_ARM64_REG_X9,
                "x10": unicorn.UC_ARM64_REG_X10, "x11": unicorn.UC_ARM64_REG_X11,
                "x12": unicorn.UC_ARM64_REG_X12, "x13": unicorn.UC_ARM64_REG_X13,
                "x14": unicorn.UC_ARM64_REG_X14, "x15": unicorn.UC_ARM64_REG_X15,
                "x16": unicorn.UC_ARM64_REG_X16, "x17": unicorn.UC_ARM64_REG_X17,
                "x18": unicorn.UC_ARM64_REG_X18, "x19": unicorn.UC_ARM64_REG_X19,
                "x20": unicorn.UC_ARM64_REG_X20, "x21": unicorn.UC_ARM64_REG_X21,
                "x22": unicorn.UC_ARM64_REG_X22, "x23": unicorn.UC_ARM64_REG_X23,
                "x24": unicorn.UC_ARM64_REG_X24, "x25": unicorn.UC_ARM64_REG_X25,
                "x26": unicorn.UC_ARM64_REG_X26, "x27": unicorn.UC_ARM64_REG_X27,
                "x28": unicorn.UC_ARM64_REG_X28, "x29": unicorn.UC_ARM64_REG_X29,
                "x30": unicorn.UC_ARM64_REG_X30,
            },
            "mips": {
                "pc": unicorn.UC_MIPS_REG_PC, "sp": unicorn.UC_MIPS_REG_SP,
                "$sp": unicorn.UC_MIPS_REG_SP, "$ra": unicorn.UC_MIPS_REG_RA,
                "$gp": unicorn.UC_MIPS_REG_GP, "$a0": unicorn.UC_MIPS_REG_A0,
                "$a1": unicorn.UC_MIPS_REG_A1, "$a2": unicorn.UC_MIPS_REG_A2,
                "$a3": unicorn.UC_MIPS_REG_A3, "$v0": unicorn.UC_MIPS_REG_V0,
                "$v1": unicorn.UC_MIPS_REG_V1,
            },
            "mipsel": {
                "pc": unicorn.UC_MIPS_REG_PC, "sp": unicorn.UC_MIPS_REG_SP,
                "$sp": unicorn.UC_MIPS_REG_SP, "$ra": unicorn.UC_MIPS_REG_RA,
