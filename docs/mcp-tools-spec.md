...
| 工具名称 | 说明 |
|----------|------|
| audit_report_finding | 报告漏洞 |
| audit_get_findings | 获取漏洞列表 |
| audit_report_finding_verification | 更新漏洞验证状态 |
...
| note_type | string | 是 | 笔记类型：finding, behavior, function_summary, data_structure, control_flow, crypto_usage, obfuscation, io_operation, general |
| title | string | 否 | 标题 |
